""" Phase of the resultant vector of three rotation vectors (pair, links)"""
import numpy as np
...
title_ax0 = "Phase of the resultant vector of three rotation vectors (pair, links)"
title_tk = title_ax0
...
def update_diagrams():
    ...
    if var_rot_precession.get():
        ...
        rotation_vector_b.rotate_all(np.deg2rad(phase_step_deg), precession_axes.get_axis_b())
        rotation_vector_c.rotate_all(np.deg2rad(phase_step_deg), precession_axes.get_axis_c())
